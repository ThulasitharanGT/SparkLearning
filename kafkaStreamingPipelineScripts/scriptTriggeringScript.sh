...
basePath=/home/raptor/IdeaProjects/SparkLearning/kafkaStreamingPipelineScripts/

spark-submit --class org.controller.kafkaStreamExample.systemCommandRunnerForShellScript --num-executors 1 --executor-cores 2 --executor-memory 1g --driver-memory 1g --driver-cores 1 $jarName scriptsNamesWithParam=$scriptsNamesWithParam basePath=$basePath
